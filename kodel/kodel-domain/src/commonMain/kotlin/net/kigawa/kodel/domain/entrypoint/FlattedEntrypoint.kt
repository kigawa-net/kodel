...
import net.kigawa.kodel.domain.log.LoggerFactory
import net.kigawa.kodel.domain.log.traceignore.debug
...
open class FlattedEntrypoint<in I, out O, C>(
    ...
    val logger = LoggerFactory.get("net.kigawa.kodel.domain.entrypoint.FlattedEntrypoint")
